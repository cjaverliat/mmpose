...
load_from = "https://download.openmmlab.com/mmpose/v1/projects/rtmposev1/rtmpose-l_simcc-aic-coco_pt-aic-coco_420e-384x288-97d6cb0f_20230228.pth"  # noqa: E501
...
model = dict(
    ...
    backbone=dict(
        ...
        frozen_stages=4,  # Freeze backbone
    ),
    head=dict(
        type="RTMCCHead",
        in_channels=1024,
